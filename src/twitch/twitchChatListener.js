...
var USER_ID = "PLACEHOLDER"; // TODO get user ID as part of the Oauth Token process and save it as a setting
var CHAT_CHANNEL_USER_ID = "PLACEHOLDER";
...
export async function runTwitchChatListener() {
  await validateToken();
